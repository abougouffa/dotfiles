...
#+begin_src emacs-lisp
(setq doom-font (font-spec :family "Mononoki Nerd Font" :size 29)
       doom-variable-pitch-font (font-spec :family "Mononoki Nerd Font" :size 29))
#+end_src
...
(use-package visual-fill-column
  :defer t
  :hook (magit-mode . dw/org-mode-visual-fill))
#+end_src
