...
For my old deprecated Doom Emacs configuration, see [[https://github.com/abougouffa/dotfiles/tree/main/dot_doom.d][=dotfiles/dot_doom.d=]].
...
#+begin_src emacs-lisp
(defun +cocogitto-bump (level)
  (interactive (list (completing-read "Bump: " '(major minor patch))))
  (shell-command "git stash -u")
  (shell-command (format "cog bump --%s" level))
