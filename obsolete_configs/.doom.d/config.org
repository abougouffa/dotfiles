...
*This Doom Emacs configuration is deprecated.* I moved to a vanilla Emacs, you can
find my current personal customization in the =dot_minemacs.d= directory, and my
personal core (reusable) Emacs configuration in [[https://github.com/abougouffa/minemacs][MinEmacs]].
