...
#+subtitle: Personal configuration for MinEmacs, Bash, Zsha, and other Linux stuff
...
[[https://github.com/abougouffa/dotfiles/tree/main/dot_obsolete_configs/dot_doom.d][=dotfiles/dot_obsolete_configs/dot_doom.d=]].
...
#+begin_src shell :tangle "setup.sh" :tangle-mode (identity #o755)
#!/bin/env bash
...
#+begin_src emacs-lisp :comments no :tangle early-config.el
...
#+begin_src emacs-lisp :comments no :tangle modules.el
...
#+begin_src gitconfig :tangle (if (executable-find "pdftotext") "~/.config/git/config" "no") :mkdirp yes
[diff "pdf"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "djvutxt") "~/.config/git/config" "no") :mkdirp yes
[diff "djvu"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "odt2txt") "~/.config/git/config" "no") :mkdirp yes
[diff "odt"]
  binary = true
  textconv = odt2txt
...
#+begin_src gitconfig :tangle (if (executable-find "catdoc") "~/.config/git/config" "no") :mkdirp yes
[diff "doc"]
  binary = true
# textconv = wvText
...
#+begin_src gitconfig :tangle (if (executable-find "xls2csv") "~/.config/git/config" "no") :mkdirp yes
[diff "xls"]
  binary = true
# textconv = in2csv
...
#+begin_src gitconfig :tangle (if (executable-find "catppt") "~/.config/git/config" "no") :mkdirp yes
[diff "ppt"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "pandoc") "~/.config/git/config" "no") :mkdirp yes
[diff "docx"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "xlsx2csv") "~/.config/git/config" "no") :mkdirp yes
[diff "xlsx"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "soffice") "~/.config/git/config" "no") :mkdirp yes
[diff "pptx"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "unrtf") "~/.config/git/config" "no") :mkdirp yes
[diff "rtf"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "tika") "~/.config/git/config" "no") :mkdirp yes
[diff "tika"]
  binary = true
...
#+begin_src gitconfig :tangle (if (executable-find "exiftool") "~/.config/git/config" "no") :mkdirp yes
[diff "exif"]
  binary = true
...
#+begin_src shell :tangle ~/.shell_extras
# -*- mode: sh; -*-
